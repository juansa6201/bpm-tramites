...
import { getTramite } from '@/lib/tramites-api';
import { ApiError } from '@/lib/api-client';
import type { TramiteDetalle } from '@/types/tramite';

interface UseTramiteDetalleResult {
...
export function useTramiteDetalle(id: string): UseTramiteDetalleResult {
  ...
  React.useEffect(() => {
    ...
    setLoading(true);
    setErrorStatus(null);
    getTramite(id, controller.signal)
      .then((res) => {
